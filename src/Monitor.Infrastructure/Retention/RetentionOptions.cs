...
public sealed class RetentionOptions
{
    ...
    public int UnlinkedLogDetailDays { get; set; } = 30;
    public int MetricDetailDays { get; set; } = 30;
    ...
    public TimeSpan UnlinkedLogDetailRetention => TimeSpan.FromDays(Math.Max(1, UnlinkedLogDetailDays));
    public TimeSpan MetricDetailRetention => TimeSpan.FromDays(Math.Max(1, MetricDetailDays));
